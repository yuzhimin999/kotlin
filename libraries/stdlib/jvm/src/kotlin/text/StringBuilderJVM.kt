...
public actual fun Appendable.appendln(): Appendable = append(SystemProperties.LINE_SEPARATOR)

/** Appends a line separator to this StringBuilder. */
public actual fun StringBuilder.appendln(): StringBuilder = append(SystemProperties.LINE_SEPARATOR)
