...
class DebugProbesImpl(context: DefaultExecutionContext) :
    ...
    val dumpMethod: Method = makeMethod("dumpCoroutinesInfo", "()Ljava/util/List;")
...
class CoroutineInfo(val debugProbesImplMirror: DebugProbesImpl, context: DefaultExecutionContext) :
    ...
    private val sequenceNumberField: Field = makeField("sequenceNumber")
    ...
    private val lastObservedStackTraceMethod: Method = makeMethod("lastObservedStackTrace")

    private val lastObservedFrameField: Field = makeField("lastObservedFrame")
    private val lastObservedThreadField: Field = makeField("lastObservedThread")
...
class CoroutineStackFrame(context: DefaultExecutionContext) :
    ...
    private val callerFrameMethod: Method = makeMethod("getCallerFrame")
