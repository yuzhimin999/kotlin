...
class JvmSerializerExtension @JvmOverloads constructor(
    ...
    override fun serializeClass(
        ...
        if (jvmDefaultMode.forAllMethodsWithBody && isInterface(descriptor)) {
            proto.setExtension(JvmProtoBuf.jvmClassFlags, JvmFlags.getPropertyFlags(true))
        }
    }
    ...
    private fun writeVersionRequirementForJvmDefaultIfNeeded(
        ...
        if (isInterface(classDescriptor)) {
            ...
            if (jvmDefaultMode == JvmDefaultMode.ALL_INCOMPATIBLE && classDescriptor.unsubstitutedMemberScope.getContributedDescriptors().isNotEmpty()) {
                builder.addVersionRequirement(
